        ...
        <div class="body">
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="input-group icon before_span">
                    ...
                    <div class="form-line">
                        <input type="text" id="name" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Enter your full name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                        @error('name')
