        ...
        <div class="row clearfix">
            <div class="col-lg-3 col-md-3 col-sm-6">
                <div class="info-box-4 hover-zoom-effect">
                    ...
                    <div class="content">
                        <div class="text">Total Apointments</div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6">
                <div class="info-box-4 hover-zoom-effect">
                    ...
                    <div class="content">
                        ...
                        <div class="number">{{$dailyAppointmentsCount}}</div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6">
                <div class="info-box-4 hover-zoom-effect">
                    <div class="icon"> <i class="zmdi zmdi-bug col-blush"></i> </div>
                    <div class="content">
                        <div class="text">Today's Treatments</div>
                        <div class="number">{{$dailyTreatmentsCount}}</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row clearfix">
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="card">
                    ...
                    <div class="body">
                        <ul class="basic-list">
                            @foreach($treatedPatients as $treated)
                                <li>{{$treated->user->name}}</li>
                            @endforeach
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="card">
                    <div class="header">
                        <h2>All PATIENTS ATTENDED</h2>
                    </div>
                    <div class="body">
                        <ul class="basic-list">
                            @foreach($appointPatients as $appointed)
                                <li>{{$appointed->user->name}}</li>
                            @endforeach
                        </ul>
                    </div>
                </div>
