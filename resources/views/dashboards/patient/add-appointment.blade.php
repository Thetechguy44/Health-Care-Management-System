        ...
        <div class="main-menu">
            <ul class="sidebar-menu scrollable">
                ...
                <li class="sidebar-item">
                    ...
                    <ul class="sidebar-link-group">
                        <li class="sidebar-dropdown-item">
                            <a href="add-appointments.html" class="sidebar-link"><span class="nav-icon"><i class="fa-light fa-table"></i></span> <span class="sidebar-txt">Add Appointment</span></a>
                        </li>
                        <li class="sidebar-dropdown-item">
        ...
        <div class="panel mb-25">
            ...
            <div class="panel-body">
                <div class="row g-3">
                    ...
                    <div class="col-sm-6">
                        <label for="basicInput" class="form-label">Doctor</label>
                        <select name=""  class="form-control" id="basicInput">
                            <option value="">Select Doctor</option>
                            <option value="">Abdullahi Bello</option>
                        </select>
                    </div>
                    <div class="col-sm-6">
                        <label for="basicInput" class="form-label">Appointment Date</label>
                        <input type="date" class="form-control" id="basicInput">
                    </div>
                    <div class="col-sm-6">
                        <label for="basicInput" class="form-label">Appointment Time</label>
                        <input type="time" class="form-control" id="basicInput">
                    </div>
                    <div class="col-sm-6">
                        <label for="basicInput" class="form-label">Symptoms</label>
                        <input type="text" class="form-control" id="basicInput">
                    </div>
                    <div class="col-sm-6">
